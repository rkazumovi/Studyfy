    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/40 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card rounded-xl border border-border p-7 shadow-card">
          <h1 className="text-xl font-display font-bold mb-1">{t("register_title")}</h1>
          <p className="text-sm text-muted-foreground mb-6">{t("register_subtitle")}</p>
          {error && (
          ...
          <p className="mt-5 text-center text-sm text-muted-foreground">
            ...
            <Link to="/login" className="text-accent font-medium hover:underline">{t("register_login_link")}</Link>
          </p>
        </div>
      </div>
    </div>
